...
#
# Summary: Test 'anssi_bp28_intermediary' hardening in the 'scap-security-guide': mitigation mode
...
sub run {
    ...
    my $profile_ID = is_sle ? $oscap_tests::profile_ID_sle_anssi_bp28_intermediary : $oscap_tests::profile_ID_tw;
