...
#
# Summary: Test 'cis_server_l1' hardening in the 'scap-security-guide': detection mode with remote
...
sub run {
    ...
    my $profile_ID =
      is_sle ? $oscap_tests::profile_ID_sle_cis_server_l1 : $oscap_tests::profile_ID_tw;
