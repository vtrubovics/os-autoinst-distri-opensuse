...
#
# Summary: Test 'cis_workstation_l2' hardening in the 'scap-security-guide': ansible mitigation mode
...
sub run {
    ...
    my $profile_ID = is_sle ? $oscap_tests::sle_version . $oscap_tests::ansible_playbook_sle_cis_workstation_l2 : $oscap_tests::ansible_playbook_standart;
