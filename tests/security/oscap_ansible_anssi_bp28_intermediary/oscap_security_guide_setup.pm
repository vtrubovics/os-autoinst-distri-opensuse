...
sub run {
    ...
    $oscap_tests::ansible_profile_ID = is_sle ? $oscap_tests::sle_version . $oscap_tests::ansible_playbook_sle_anssi_bp28_intermediary : $oscap_tests::ansible_playbook_standart;
