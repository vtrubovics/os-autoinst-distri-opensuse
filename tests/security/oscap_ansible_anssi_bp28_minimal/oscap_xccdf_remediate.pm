...
#
# Summary: Test 'anssi_bp28_minimal' hardening in the 'scap-security-guide': ansible mitigation mode
...
sub run {
    ...
    my $profile_ID = is_sle ? $oscap_tests::sle_version . $oscap_tests::ansible_playbook_sle_anssi_bp28_minimal : $oscap_tests::ansible_playbook_standart;
