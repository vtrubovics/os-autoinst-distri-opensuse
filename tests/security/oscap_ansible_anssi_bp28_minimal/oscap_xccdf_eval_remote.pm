...
#
# Summary: Test 'anssi_bp28_minimal' hardening in the 'scap-security-guide': detection mode with remote
...
sub run {
    ...
    my $profile_ID =
      is_sle ? $oscap_tests::profile_ID_sle_anssi_bp28_minimal : $oscap_tests::profile_ID_tw;
