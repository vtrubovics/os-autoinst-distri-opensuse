...
#
# Summary: Test 'cis_workstation_l1' hardening in the 'scap-security-guide': mitigation mode
...
sub run {
    ...
    my $profile_ID = is_sle ? $oscap_tests::profile_ID_sle_cis_workstation_l1 : $oscap_tests::profile_ID_tw;
